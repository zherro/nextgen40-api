...
public interface AccountSearchRepository extends GenericSearchRepository<AccountSearch> {
...
//    @Query("{\"bool\": {\"must\": {\"match\": {\"title\": \"?0\"}}, \"filter\": {\"term\": {\"tags\": \"?1\" }}}}")
    ...
    @Query("{" +
            ...
            "  }" +
            "}")
    Page<AccountSearch> findByStringFilter(String filter, Pageable pageable);
}
